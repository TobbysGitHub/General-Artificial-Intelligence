...
1. The supervision of target output relies on reinforcement process rather than optimization. It is reinforcement, rather than optimizition, that is global.
